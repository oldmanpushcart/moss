...
@Component
@ChatFnName("moss_chat_vision_fn")
@ChatFnDescription("图片、视频理解：可根据提示词要求对话中有关图片、视频进行理解")
public class MossChatVisionFunction
        implements ChatFunction<MossChatVisionFunction.Parameter, MossChatVisionFunction.Result> {
